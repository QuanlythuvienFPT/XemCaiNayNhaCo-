...
namespace GUI_QUANLYTHUVIEN
{
    public partial class frmTheLoaiSach : Form
    {
        ...
        {
            dgvTheLoaiSach.DataSource = bus.GetAll();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            dgvTheLoaiSach.DataSource = bus.Search(tuKhoa);
        }

        private void dgvTheLoaiSach_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.RowIndex < dgvTheLoaiSach.Rows.Count)
            {
